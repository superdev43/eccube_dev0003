...
class CusCustomerController extends AbstractController
{
    /**
     ...
     * @Template("@CustomShipping/admin/Customer/customer_list.twig")
     */
    public function cus_index(Request $request, $page_no = null, Paginator $paginator)
    {
