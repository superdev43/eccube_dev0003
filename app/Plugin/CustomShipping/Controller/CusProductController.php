...
class CusProductController extends \Eccube\Controller\AbstractController
{
     ...
     * @return array
     */
    public function cus_detail(Request $request, Product $Product)
    {
        $currentRoute = $request->attributes->get('_route');
        ...
        if ($this->getUser() == null && $Page->getIsPremMember() == 1) {
            ...
            return [
                ...
                'cateogryId' => $CagegoryIdOfProduct
            ];
        }
