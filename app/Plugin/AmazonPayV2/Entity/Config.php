...
/*   __________________________________________________
    ...
    |__________________________________________________|
*/
namespace Plugin\AmazonPayV2\Entity;use Doctrine\ORM\Mapping as ORM;use Eccube\Entity\AbstractEntity;/**
 * Config
 *
 * @ORM\Table(name="plg_amazon_pay_v2_config")
 * @ORM\Entity(repositoryClass="Plugin\AmazonPayV2\Repository\ConfigRepository")
 */
