...
class CategoryRepository extends AbstractRepository
{
    ...
    public function getItemFindList(Category $Parent = null, $flat = false)
    {
        $itemCategoryList = ['選択ださい','広州仕入れ', 'アソート', 'ブランド福袋', '放映記念アソート', '大特価・送料無料'];
        $qb = $this->createQueryBuilder('c')->orderBy('c.id', 'ASC');
        $Categories = $qb->getQuery()->getResult();
        $array = [];
        foreach ($Categories as $Category) {
            if (array_search($Category->getName(), $itemCategoryList, true) != false) {
                $array[] = $Category;
            }
        }
        return $array;
